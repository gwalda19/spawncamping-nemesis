...
public class SoundPlayer extends JComponent {
    ...
    public JButton play;             // The Play/Stop button
    public JSlider progress;         // Shows and sets current position in sound
    JLabel time;              // Displays audioPosition as a number
    public Timer timer;              // Updates slider every 100 milliseconds
