...
public class HomeRunStatsGui extends JFrame implements HomeRunObserver{
	...
	private JComboBox comboboxBatterTeam;
	private JComboBox comboboxPitcherTeam;
	private JComboBox comboboxBatter;
	private JComboBox comboboxPitcher;
	private JComboBox comboboxInning;
	private JComboBox comboboxGameOutcome;
	private JComboBox comboboxOuts;
	private JComboBox comboboxBalls;
	private JComboBox comboboxStrikes;
	private JComboBox comboboxTimeOfDay;
	private JComboBox comboboxPhilliesScore;
	private JComboBox comboboxVisitorsScore;
	private JComboBox comboboxRunsScored;
	private JComboBox comboboxLRHandedBatter;
	...
	private ArrayList<HomeRun> backupFilteredHomeRunArrayList = new ArrayList<HomeRun>();
	private HomeRunGraphicsSurface hrGraphicsSurf = new HomeRunGraphicsSurface(masterList);
	private PitchLocationGraphicsSurface locationGraphSurf = new PitchLocationGraphicsSurface(masterList);
	private JTextField jtfDistanceMax;
	private JTextField jtfDistanceMin;
			...
			try{
			  ...
			  if (startDate.compareTo(endDate)>0){
			    ...
			    //startDate is before endDate
					...
					filterString[15] = (String) comboboxLRHandedBatter.getSelectedItem().toString(); 
